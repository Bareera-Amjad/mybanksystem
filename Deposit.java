...
// Set default close operation to enable X button functionality
setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

// Do not use setUndecorated(true) if you want the title bar with the X button
setVisible(true);
...
// Frame setup (only in the constructor)
