...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    JLabel additionalDetails,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13;
    JButton b;
    ...
    SignupTwo(String formno){
      ...
      // Load image from resources folder or inside package
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/bankBackground.jpeg"));
        Image i2 = i1.getImage().getScaledInstance(800, 700, Image.SCALE_SMOOTH);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l4 = new JLabel(i3);
        l4.setBounds(0, 200, 500, 480);
        setContentPane(l4);
        ...
        ImageIcon bgIcon = new ImageIcon(getClass().getResource("/icons/bankBackground.jpeg"));
        ...
        String category[] = {"General","Individual","Government","corporate","Other"};
    ...
    if (t1.getText().equals("")) {
        ...
        // Create a string with all form details
        String userData = formno + "," + religion + "," + category + "," + income + "," + 
                          education + "," + occupation + "," +
                          t1.getText() + "," + scitizen + "," + eaccount + "\n";

        // Save to file
        FileWriter fw = new FileWriter("signup2.txt", true); // 'true' for append mode
        fw.write(userData);
        fw.close();
